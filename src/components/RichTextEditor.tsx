...
>(
  (
    ...
    }, [isEditorFocused, showToolbar, onToolbarVisibilityChange])
      ...
      <div className="plasmo-relative plasmo-h-full plasmo-flex plasmo-flex-col plasmo-bg-transparent">
        ...
        {onSummarize && (
          <button
            ...
            className="plasmo-absolute plasmo-top-4 plasmo-right-4 plasmo-z-10 plasmo-px-3 plasmo-py-1.5 plasmo-text-xs plasmo-text-purple-600 hover:plasmo-bg-purple-50 plasmo-rounded-lg plasmo-font-medium disabled:plasmo-opacity-40 disabled:plasmo-cursor-not-allowed plasmo-transition-colors plasmo-flex plasmo-items-center plasmo-gap-1.5 plasmo-shadow-sm plasmo-bg-white plasmo-border plasmo-border-purple-200"
        ...
        <div
          ...
          <EditorContent
            editor={editor}
            className={`plasmo-bg-transparent plasmo-h-full ${compact ? "compact-editor" : ""}`}
          />
        </div>
