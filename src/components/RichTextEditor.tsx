...
export const RichTextEditor = forwardRef<
  RichTextEditorRef,
  RichTextEditorProps
>(({ initialContent, placeholder = "Start typing...", onUpdate, onSummarize, isSummarizing }, ref) => {
        ...
        {editor.isActive("table") && (
          <>
            <button
              ...
              <span className="plasmo-text-xs plasmo-font-semibold">+Col</span>
            </button>
            ...
            <button
              ...
              <span className="plasmo-text-xs plasmo-font-semibold">+Row</span>
            </button>
            ...
            <button
              ...
              <span className="plasmo-text-xs plasmo-font-semibold">TH</span>
            </button>
          </>
        )}
      </div>
