          ...
          <div
            ...
            {tabs.map((tab, idx) => (
              <button
                ...
                <span
                  className={`plasmo-relative plasmo-block plasmo-text-sm plasmo-font-light plasmo-capitalize plasmo-transition-colors plasmo-duration-200 plasmo-whitespace-nowrap plasmo-flex plasmo-items-center plasmo-gap-2 ${
                    active.value === tab.value
                      ? "plasmo-text-white"
...
export const FadeInDiv = ({
  ...
  return (
    <div className="plasmo-relative plasmo-w-full plasmo-h-full plasmo-overflow-hidden">
      {tabs.map((tab, idx) => (
        <motion.div
          key={tab.value}
          layoutId={tab.value}
          ...
          className={`plasmo-w-full plasmo-h-full plasmo-absolute plasmo-top-0 plasmo-left-0 plasmo-pt-16 plasmo-overflow-y-auto plasmo-no-visible-scrollbar ${className || ""}`}>
          {tab.content}
        </motion.div>
      ))}
    </div>
